    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAccountUserRole", x => new { x.UserAccountId, x.UserRoleId });
                    table.ForeignKey(
                        name: "FK_UserAccountUserRole_UserAccounts_UserAccountId",
                        column: x => x.UserAccountId,
                        principalTable: "UserAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserAccountUserRole_UserRoles_UserRoleId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "SuperAdmin", "[\"Permissions.All\"]" });

            migrationBuilder.InsertData(
                table: "UserRoles",
                columns: new[] { "Id", "Name", "Permissions" },
                values: new object[] { 2, "Admin", "[\"Permissions.Users.View\"]" });

            migrationBuilder.InsertData(
                table: "UserRoles",
                columns: new[] { "Id", "Name", "Permissions" },
                values: new object[] { 3, "Basic", "[]" });
